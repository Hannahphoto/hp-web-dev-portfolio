    ...
    return(
        <>
            ...
            <h3>
                ...
                <ul>UPenn LPS in collaboration with edX Boot Camps. Full Stack 
                Web Development, Front & Back End.  September 2023 - March 2024.</ul>

                <ul>Yale University School of Art, MFA in Photography, May 19th, 2014.</ul>

                <ul>Rochester Institute of Technology.  BFA in Professional Photographic Illustration, Minor in Applied Imaging Systems, May 2009.</ul>

               <ul>Magnum Photos Nominee 2020-2022.</ul>

               <h4>
                REFERENCE
            </h4>
            <p>
                Kara Crombie, Department Chair, Photographic Imaging
